...
class GetAllUserAlcDrinks extends StatefulWidget {
  const GetAllUserAlcDrinks({super.key, required this.documentID});

  final String documentID;

  @override
  State<GetAllUserAlcDrinks> createState() => _GetAllUserAlcDrinksState();
}

class _GetAllUserAlcDrinksState extends State<GetAllUserAlcDrinks> {
