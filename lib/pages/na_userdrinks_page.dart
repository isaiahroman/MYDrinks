...
import '/read_data/get_na_user_drinks.dart';

class UserNonAlcDrinks extends StatefulWidget {
  const UserNonAlcDrinks({super.key});

  @override
  State<UserNonAlcDrinks> createState() => _UserNonAlcDrinksState();
}

class _UserNonAlcDrinksState extends State<UserNonAlcDrinks> {
